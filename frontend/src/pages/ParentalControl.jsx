...
import { 
  ...
  Clock, Eye, MessageCircle, Bell, Filter
} from "lucide-react";
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="form-control">
                <label className="text-sm font-medium text-gray-700">Filter Level</label>
                <select
                  value={settings.filterLevel}
                  onChange={(e) => handleSettingChange('filterLevel', e.target.value)}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="form-control">
                  ...
                  <input
                    ...
                    onChange={(e) => handleSettingChange('monitoringHours', {
              ...
              <div className="form-control">
                <label className="flex items-center">
                  <input
                    ...
                    className="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                  />
                  <span className="ml-2 text-sm text-gray-600">Allow Weekend Access</span>
                </label>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6">
            ...
            <div className="space-y-4">
              {/* Chat Restrictions */}
              <div className="form-control">
                <label className="text-sm font-medium text-gray-700">Chat Restrictions</label>
                <select
                  value={settings.chatRestrictions}
                  onChange={(e) => handleSettingChange('chatRestrictions', e.target.value)}
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                >
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6">
            ...
            <div className="space-y-4">
              {/* Report Frequency */}
              <div className="form-control">
                <label className="text-sm font-medium text-gray-700">Activity Reports</label>
                <select

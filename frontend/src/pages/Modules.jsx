...
import VidyaButton from "../components/vidya_button"; // Add this import
...
const AdventureMapUI = () => {
  ...
  const adventureLocations = [
    {
      ...
      completed: true,
      description:
        "Start your journey in the friendly village. Perfect for beginners!",
      subtopics: [],
    },
    {
      id: "forest",
  ...
  const handleSelectSubtopic = (subtopicId) => {
    if (selectedLocation) {
      const foundSubtopic = selectedLocation.subtopics
        .flatMap((topic) => topic.subtopics.find((s) => s.id === subtopicId))
        .filter(Boolean)[0];
  ...
  return (
    <>
      <Container maxWidth="lg" sx={{ py: 4 }}>
        <Box
          sx={{
            ...
            overflow: "hidden",
            boxShadow:
              "inset 0 0 0 4px rgba(255,255,255,0.05), 0 10px 30px rgba(0,0,0,0.2)",
              ...
              <Box sx={{ position: "relative", height: "70%" }}>
                ...
                <Box
                  sx={{
                    ...
                    height: "40%",
                    background:
                      "linear-gradient(to top, #8d6e63 0%, #a1887f 15%, #81c784 15%, #66bb6a 100%)",
                ...
                >
                  ...
                  {[...Array(8)].map((_, i) => (
                    <circle
                      ...
                      fill="#90caf9"
                      style={{
                        animation: `ripple ${3 + i * 0.5}s infinite ease-out ${
                          i * 0.7
                        }s`,
                      }}
                    />
                      ...
                      <Box
                        ...
                        sx={{
                          ...
                          "@keyframes smoke": {
                            ...
                            "100%": {
                              transform: "translate(-15px, -40px) scale(2)",
                              opacity: 0,
                            },
                          },
                        }}
                ...
                <Box
                  sx={{
                    ...
                    "&:hover": {
                      transform:
                        "translateX(-50%) scale(1.05) translateY(-5px)",
                    },
                  }}
                ...
                >
                  ...
                  <Box
                    sx={{
                      ...
                      backgroundImage:
                        "repeating-linear-gradient(0deg, #5d4037, #5d4037 3px, #8d6e63 3px, #8d6e63 10px)",
                    }}
                  >
                    {/* Door */}
                    <Box
                ...
                <Box
                  sx={{
                    ...
                    cursor: completedLocations.includes("forest")
                      ? "pointer"
                      : "not-allowed",
                    transition: "transform 0.3s",
                    "&:hover": {
                      transform: completedLocations.includes("forest")
                ...
                >
                  ...
                  <Box
                    sx={{
                      ...
                      width: "70%",
                      height: "120px",
                      backgroundColor: completedLocations.includes("forest")
                        ? "#9575cd"
                        : "#bdbdbd",
                      borderRadius: "5px 5px 0 0",
                      boxShadow: "0 5px 15px rgba(0,0,0,0.2)",
                      border: completedLocations.includes("forest")
                        ? "2px solid #5e35b1"
                        : "2px solid #9e9e9e",
                    }}
                  >
                ...
                {[...Array(12)].map((_, i) => (
                  <Box
                    ...
                    sx={{
                      ...
                      transform: `scale(${0.7 + Math.random() * 0.6}) rotate(${
                        -5 + Math.random() * 10
                      }deg)`,
                  ...
                  <Box
                    ...
                    sx={{
                      ...
                      [`@keyframes butterfly-path-${i}`]: {
                        ...
                        "25%": {
                          transform: `translate(${20 + i * 10}px, ${
                            -30 - i * 5
                          }px) rotate(-10deg)`,
                        },
                        "50%": {
                          transform: `translate(${50 + i * 15}px, ${
                            -10 - i * 3
                          }px) rotate(5deg)`,
                        },
                        "75%": {
                          transform: `translate(${30 + i * 10}px, ${
                            -20 - i * 4
                          }px) rotate(-5deg)`,
                        },
                      },
                    ...
                    >
                      ...
                      <Box
                        sx={{
                          ...
                          animation:
                            "wing-flap 0.15s infinite alternate-reverse",
                        }}
                      />
                      <Box
                        sx={{
      ...
      {/* Add VidyaButton outside the Container component */}
      <VidyaButton />
    </>
  );
};

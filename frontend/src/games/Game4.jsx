...
export const storyContent = {
  0: {
    // Story 0: Understanding Your Body
    ...
    scenes: [
      {
        ...
        title: "Growing Up",
        content:
          "Swathi is feeling confused about the changes happening to her body. Her friends seem to be experiencing similar changes, but no one talks about it openly.",
        background: "bedroom",
        character: "swathi",
        emotion: "nervous",
        dialog:
          "I've noticed some changes in my body lately. My mom mentioned puberty, but I'm not sure what to expect.",
        choices: [
          {
            ...
            feedback:
              "Great choice! Talking to a trusted adult is always helpful when you have questions about your body.",
          },
          {
            ...
            feedback:
              "While the internet can provide helpful information, make sure to use trusted sources and remember that talking to adults you trust is still important.",
          },
          {
            ...
            feedback:
              "It's natural to feel shy about these topics, but ignoring the changes won't make them go away. Learning about your body is important for your health.",
          },
        ],
        eduTip:
          "Puberty typically begins between ages 8-13 for girls and 9-14 for boys, but everyone's timeline is different. Changes are normal and healthy.",
      },
      {
        id: 1,
        title: "Talking with Mom",
        content:
          "Swathi decides to talk to her mother about the changes she's noticing.",
        background: "livingroom",
        character: "mom",
        emotion: "calm",
        dialog:
          "I'm glad you came to talk to me, Swathi. Puberty is a natural part of growing up, and everyone goes through it. Let's discuss what you might experience.",
        choices: [
          {
            ...
            feedback:
              "Good question! Understanding physical changes helps you prepare for what's coming.",
          },
          {
            ...
            feedback:
              "Excellent! Emotional changes are just as important to understand as physical ones.",
          },
          {
            ...
            feedback:
              "Great thinking! Good hygiene practices become even more important during puberty.",
          },
        ],
        eduTip:
          "Open communication with trusted adults helps build a support system as you navigate changes in your life.",
      },
      {
        id: 3,
        title: "Avoiding the Topic",
        content:
          "Swathi decides to ignore the changes happening to her body, hoping they will just go away.",
        background: "bedroom",
        character: "swathi",
        emotion: "sad",
        dialog:
          "Maybe if I don't think about these changes, they'll stop happening. I don't want to talk about embarrassing things.",
        choices: [
          {
            ...
            feedback:
              "It's okay to change your mind! Talking to a trusted adult is a good decision.",
          },
          {
            ...
            feedback:
              "Friends can be supportive, but they might not have all the right information. Consider also talking to a trusted adult.",
          },
          {
            ...
            feedback:
              "Avoiding important health topics can lead to anxiety and missing out on important information. It's always better to learn about your changing body.",
          },
        ],
        eduTip:
          "Many young people feel embarrassed about puberty, but knowledge is important for health. Everyone goes through these changes, and they're completely normal.",
      },
      {
        id: 4,
        title: "Physical Changes",
        content:
          "Swathi's mom explains the physical changes that happen during puberty.",
        background: "livingroom",
        character: "mom",
        emotion: "calm",
        dialog:
          "During puberty, your body will develop in many ways. You'll grow taller, develop breasts, grow hair in new places, and eventually start menstruation. All of these changes are normal and happen to everyone.",
        choices: [
          {
            ...
            feedback:
              "Great question! Understanding menstruation helps you prepare for this normal part of growing up.",
          },
          {
            ...
            impact: { health: 10, confidence: 5, knowledge: 10 },
            feedback:
              "Good thinking! Hygiene becomes even more important during puberty.",
          },
          {
            ...
            feedback:
              "That's a thoughtful question! Understanding that everyone goes through similar changes can help you feel less alone.",
          },
        ],
        eduTip:
          "Physical changes during puberty happen to everyone, but the timing and pace vary from person to person. There's no 'right' way or timeline for development.",
      },
      ...
      questions: [
        {
          ...
          options: ["Ages 5-8", "Ages 8-14", "Ages 16-18", "Ages 20-22"],
          correctAnswer: 1,
          explanation:
            "Puberty typically begins between ages 8-13 for girls and 9-14 for boys, though the exact timing varies for everyone.",
        },
        {
          question:
            "Which of these is NOT a typical physical change during puberty?",
          options: [
            "Growth spurts",
            "Voice changes",
          ...
          correctAnswer: 3,
          explanation:
            "During puberty, people experience growth spurts (getting taller), not shrinking in height.",
        },
        // More quiz questions...
      ],
    },
    ...
    scenes: [
      {
        ...
        content:
          "Swathi is learning about personal boundaries and when it's okay to say 'no'.",
        background: "school",
        character: "swathi",
        emotion: "nervous",
        dialog:
...
const Game4 = ({ onBack }) => {
  ...
  useEffect(() => {
    ...
    // Initialize default achievement
    setNewAchievement({
  ...
  const updateCharacterAttributes = (choice) => {
    ...
    if (choice.impact.health) {
      setHealthMeter((prev) =>
        Math.max(0, Math.min(100, prev + choice.impact.health))
      );
    }

    if (choice.impact.confidence) {
      setConfidenceMeter((prev) =>
        Math.max(0, Math.min(100, prev + choice.impact.confidence))
      );
    }

    if (choice.impact.knowledge) {
      setKnowledgeMeter((prev) =>
        Math.max(0, Math.min(100, prev + choice.impact.knowledge))
      );
    }
  ...
  const renderCharacterDialog = () => {
    ...
    const avatarUrl =
      characterAvatars["swathi"] || "https://via.placeholder.com/40";
      ...
      <Fade in={showAchievementPopup}>
        ...
        >
          ...
          >
            ...
            >
              {newAchievement?.icon || (
                <Star sx={{ fontSize: 50, color: "#ffab00" }} />
              )}
            </Box>
        ...
        >
          ...
          <motion.div
            ...
            style={{
              ...
              bottom: 0,
              background:
                "radial-gradient(circle at center, transparent 0%, rgba(156, 39, 176, 0.2) 70%, rgba(156, 39, 176, 0.3) 100%)",
              zIndex: 0,
            }}
          />
        </Box>
        ...
        >
          ...
          <Box sx={{ mb: 6, textAlign: "center" }}>
            ...
            >
              ...
              >
                Join Swathi's journey through important life lessons and
                discover the path to confident growing up
              </Typography>
            </motion.div>
          </Box>
          ...
          <Grid container spacing={4} sx={{ alignItems: "center", mb: 4 }}>
            ...
            <Grid
              ...
              xs={12}
              md={6}
              sx={{ position: "relative", height: { xs: 350, md: 400 } }}
            >
              ...
              >
                ...
                <Box
                  ...
                  sx={{
                    ...
                    borderRadius: "50%",
                    background:
                      "radial-gradient(circle, rgba(156,39,176,0.4) 0%, rgba(233,30,99,0.2) 50%, rgba(156,39,176,0) 70%)",
                    filter: "blur(30px)",
                    top: "50%",
                    left: "50%",
                    transform: "translate(-50%, -50%)",
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Box
                        component="span"
                        sx={{ color: "#e91e63", mr: 1, fontWeight: "bold" }}
                      >
                        Swathi:
                      </Box>
                      <Box component="span">
                        Hi! I'm Swathi. I'll help you navigate the challenges of
                        growing up and learn about important topics in a fun
                        way!
                      </Box>
                    </Typography>
                  </Paper>
              ...
              {[
                {
                  ...
                  desc: "Learn about your body and wellness",
                },
                {
                  icon: <Psychology sx={{ fontSize: 40 }} />,
                  title: "Emotional Growth",
                  desc: "Understand feelings and relationships",
                },
                {
                  icon: <School sx={{ fontSize: 40 }} />,
                  title: "Life Skills",
                  desc: "Build skills for confident living",
                },
                {
                  icon: <EmojiPeople sx={{ fontSize: 40 }} />,
                  title: "Self Confidence",
                  desc: "Develop a positive self-image",
                },
              ].map((item, index) => (
      ...
      >
        ...
        <Grid container spacing={3} justifyContent="center">
          {stories.map((story) => {
            ...
            const isLocked =
              story.id === 0 ? false : !unlockedStories.includes(story.id);
                ...
                >
                  ...
                  >
                    ...
                    >
                      {story.id === 0 && (
                        <Favorite
                          sx={{ fontSize: 60, color: "rgba(255,255,255,0.7)" }}
                        />
                      )}
                      {story.id === 1 && (
                        <Psychology
                      ...
                      <Box sx={{ mt: "auto" }}>
                        <Button
                          ...
                          onClick={() => {
                            ...
                            setCharacterDialogContent(
                              `I'm ready to explore ${story.title}. Let's go!`
                            );
    ...
    return (
      <>
        ...
        >
          ...
          >
            {dialogContent.type === "info" && (
              <Info sx={{ mr: 1, color: darkMode ? "#90caf9" : "#2196f3" }} />
            )}
            {dialogContent.type === "warning" && (
              <Warning
                sx={{ mr: 1, color: darkMode ? "#ffb74d" : "#ff9800" }}
              />
            )}
            {dialogContent.type === "success" && (
              <Check sx={{ mr: 1, color: darkMode ? "#a5d6a7" : "#4caf50" }} />
            )}
            {dialogContent.title}
          </DialogTitle>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {scene.character === "swathi"
                ? "S"
                : scene.character === "mom"
                ? "M"
                : scene.character === "teacher"
                ? "T"
                : "?"}
            </Avatar>
            <Box>
            ...
            {emotionIcons[scene.emotion] && (
              <Tooltip title={`Feeling ${scene.emotion}`}>
                <Box sx={{ ml: "auto" }}>{emotionIcons[scene.emotion]}</Box>
              </Tooltip>
            )}
          </Box>
        </Paper>
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
          {scene.choices.map((choice, index) => (
            <Button
              ...
              variant="contained"
              color={
                index === 0 ? "primary" : index === 1 ? "info" : "secondary"
              }
              sx={{
                py: 1.5,
  ...
  const handleChoiceSelected = (choice) => {
    ...
    if (choice.impact) {
      ...
      const buttonIndex =
        choice.impact.health > 0 ? 0 : choice.impact.confidence > 0 ? 1 : 2;
      ...
      if (choice.impact.health > 0 || choice.impact.confidence > 0) {
        ...
        setCharacterDialogContent(
          "I'm not sure if that was the best choice..."
        );
      } else {
        setCharacterDialogContent(
        ...
        >
            ...
            {previousEmotion !== characterEmotion && (
              ...
              >
                <Box
                  component="img"
                  src={
                    swathiEmotionImages[previousEmotion] ||
                    swathiEmotionImages.neutral
                  }
                  alt="Swathi"
                  sx={{
                    width: "100%",
          ...
          >
            <Box
              component="img"
              src={
                swathiEmotionImages[characterEmotion] ||
                swathiEmotionImages.neutral
              }
              alt="Swathi"
              sx={{
            ...
            >
              ...
              <Paper
                ...
                sx={{
                  ...
                  alignItems: "center",
                  background:
                    "linear-gradient(45deg, #ff9800 30%, #ff6d00 90%)",
                }}
              >
              ...
              {streak > 0 && (
                ...
                >
                  <Forum
                    sx={{ color: streak >= 5 ? "white" : "#757575", mr: 1 }}
                  />
                  <Typography
                    variant="subtitle2"
                    sx={{
                ...
                >
                  <IconButton
                    ...
                    sx={{
                      ...
                      "&:hover": {
                        background:
                          "linear-gradient(45deg, #aa2aba 30%, #7e57c2 90%)",
                      },
                    }}
                  >
                    <Celebration />

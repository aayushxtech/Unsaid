...
const Navbar = () => {
  ...
  return (
    <nav className={`sticky top-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-lg py-3' : 'bg-blue-50 py-4'} rounded-b-lg`}>
            ...
            {!user ? (
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  ...
                  <svg 
                    className={`w-5 h-5 transition-transform duration-300 ${showUserDropdown ? 'rotate-180' : ''}`} 
                    fill="currentColor" 
                    viewBox="0 0 20 20"
                  >
                ...
                {showUserDropdown && (
                  ...
                  >
                    <div className="px-4 py-3 border-b border-gray-100">
                      ...
                      <p className="text-sm font-medium text-purple-700 truncate">{user?.email || 'User'}</p>
                    </div>
                    <a href="/profile" className="flex items-center px-4 py-3 text-gray-700 hover:bg-purple-50 hover:text-purple-700 transition-colors duration-200">
                      <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd"></path>
                      </svg>
                      Profile
                    </a>
                    <a href="/settings" className="flex items-center px-4 py-3 text-gray-700 hover:bg-purple-50 hover:text-purple-700 transition-colors duration-200">
                      <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clipRule="evenodd"></path>
                      </svg>
                      Settings
                    </a>
                    <a href="/achievements" className="flex items-center px-4 py-3 text-gray-700 hover:bg-purple-50 hover:text-purple-700 transition-colors duration-200">
                      <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    >
                      <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M3 3a1 1 0 00-1 1v12a1 1 0 001 1h12a1 1 0 001-1V7.414l-5-5H3zm7 5a1 1 0 01-1-1V3.414L13.586 8H10z" clipRule="evenodd"></path>
                        <path d="M10 12a2 2 0 100-4 2 2 0 000 4z"></path>
                        <path fillRule="evenodd" d="M3 3a1 1 0 00-1 1v12a1 1 0 001 1h12a1 1 0 001-1V7.414l-5-5H3zm3 14a1 1 0 01-1-1v-1h8a1 1 0 110 2H5zm0-4a1 1 0 110-2h8a1 1 0 110 2H5z" clipRule="evenodd"></path>
                      </svg>
                      Log Out
                    </button>
                  </div>
      ...
      <div 
        className={`md:hidden fixed inset-0 z-40 transform ${mobileMenuOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300`}
            ...
            {user && (
              <div className="mb-5 p-4 bg-purple-50 rounded-lg">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="font-medium text-purple-700">{user?.email?.split('@')[0] || 'User'}</p>
            ...
            {!user ? (
              ...
              <div className="space-y-3">
                ...
                <div className="pt-4 border-t border-gray-100 mt-4">
                  ...
                  >
                    <svg className="w-6 h-6 mr-4" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M3 3a1 1 0 011 1v12a1 1 0 01-1 1h12a1 1 0 001-1V7.414l-5-5H4a1 1 0 00-1 1v12zm9.707-5.707L9 3.586V9h5.414l-1.707-1.707z" clipRule="evenodd"></path>
                    </svg>
                    Log Out
                  </button>
                </div>
